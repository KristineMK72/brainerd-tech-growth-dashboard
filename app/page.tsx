...
const wageBarOptions: ChartOptions<"bar"> = {
  responsive: true,
  maintainAspectRatio: false,
  plugins: {
...
export default function Home() {
  ...
  const techShare = useMemo(() => {
    const p = SECTORS.find((s) => s.name.startsWith("Professional"))?.share ?? 0;
    const i = SECTORS.find((s) => s.name.startsWith("Information"))?.share ?? 0;
    return p + i;
  }, []);
  ...
  const childcarePerDay = 0; // optional add-on
      ...
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-10">
          ...
          <p className="text-lg md:text-xl text-gray-700">
            Wages, commuting, and local opportunity • {dataset.name}
          </p>
        </header>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 md:justify-between">
            ...
            <div>
              ...
              <div className="mt-1 inline-flex rounded-lg border border-gray-200 overflow-hidden">
                <button
                  ...
                  className={`px-3 py-2 text-sm ${
                    wageMode === "median" ? "bg-indigo-600 text-white" : "bg-white text-gray-700"
                  }`}
                >
                  Median
                </button>
                <button
                  ...
                  className={`px-3 py-2 text-sm ${
                    wageMode === "mean" ? "bg-indigo-600 text-white" : "bg-white text-gray-700"
                  }`}
                >
                  Mean
                </button>
              ...
              <div className="text-xs text-gray-500 mt-1">
                Median = typical worker; Mean = pulled up by high earners
              </div>
            </div>
        ...
        <section className="mb-14">
          ...
          <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-5 mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              <span className="font-medium">{top3.join(", ")}</span>. Expanding tech jobs—especially IT roles
              inside non-tech employers—can diversify the local economy, support higher wages, and strengthen
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-6">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                ...
                {commuters.toLocaleString()} commuters, ~{rtMiles} miles round-trip, ~{rtMinutes} minutes
                round-trip, {tripsPerYear} workdays/year.
              </p>
              ...
              <div className="mt-4 grid grid-cols-1 gap-3">
                <div className="bg-white rounded-xl border border-indigo-100 p-4">
                  ...
                  <div className="text-xs text-gray-500">72.5¢/mile (business standard mileage rate).</div>
                </div>
                ...
                <div className="bg-white rounded-xl border border-indigo-100 p-4">
                  ...
                  <div className="text-xs text-gray-500">
                    Uses ${valueOfTimePerHour}/hour to represent time burden (editable).
                  </div>
                </div>
